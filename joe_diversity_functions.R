### Joe's function for diversity analysis with phyloseq
...
mypar <- function(a=1,b=1,brewer.n=8,brewer.name="Paired",cex.lab=1,cex.main=1.2,cex.axis=1,mar=c(2.5,2.5,1.6,1.1),mgp=c(1.5,.5,0),...){
